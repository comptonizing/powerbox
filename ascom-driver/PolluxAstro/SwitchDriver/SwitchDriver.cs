...
//
// ASCOM Switch driver for PolluxAstroPowerbox
//
...
namespace ASCOM.PolluxAstroPowerbox.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.PolluxAstroPowerbox.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.PolluxAstroPowerbox.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _PolluxAstroPowerbox from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("5fa33450-b276-4c86-a78f-a6b88d82b5da")]
    [ProgId("ASCOM.PolluxAstroPowerbox.Switch")]
    [ServedClassName("PolluxAstro Powerbox")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolluxAstroPowerbox"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "PolluxAstroPowerbox.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
